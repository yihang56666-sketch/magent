#!/usr/bin/env python3
"""Legacy robust executor wrapper for Codex-only manual runs."""
...
def main() -> int:
    ...
    parser.add_argument("--resume", action="store_true", help="Refresh summary from existing outputs")
    ...
    summary["legacy_executor"] = "robust-executor"
